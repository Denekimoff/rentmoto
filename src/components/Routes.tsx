    ...
    const routesData: Array<RouteDataType> = [
        {
            ...
            image: {
                1: './src/images/base-route-1.png',
                2: './src/images/base-route-2.png',
            },
        },{
            title: 'РАСШИРЕННЫЙ',
            price: '630',
            ...
            route: 'Смотровая - Родник - Камень Джигита - Адербиевка - Гора Нексис - Грозовые Ворота - Шашлыки - Цыгельский водопад (чаша любви) - Форсаж',
            image: {
                1: './src/images/long-route-1.png',
                2: './src/images/long-route-2.png',
            },
        },{
            title: 'ПРОДВИНУТЫЙ',
            price: '320',
            ...
            image: {
                1: './src/images/expirience-route-1.png',
                2: './src/images/expirience-route-2.png',
            },
        },
    ]
  return (
                        ...
                        <div key={id} className="routes__container__list__item">
                            <div className="routes__container__list__item__info">
                                ...
                                <div className="routes__container__list__item__info__description">
                                    <p>ВРЕМЯ В ПУТИ: <span>{el.time}</span></p>
                                    <p>РАССТОЯНИЕ: <span>{el.distance}</span></p>
                                    <p>СЛОЖНОСТЬ: <span>{el.rate}</span></p>
                                </div>
