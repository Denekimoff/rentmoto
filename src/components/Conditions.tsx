...
export default function Conditions() {
    const conditionsData = ['При прокате или аренде строго соблюдать правила техники безопасности и все требования инструктора!',
        ...
        <Wrapper>
            <div className="conditions__container">
                ...
                <ul className="conditions__container__list">
                    ...
                    <li key={id} className='conditions__container__list__item'>{el}</li>
                    )}
                </ul>
            </div>
        </Wrapper>
